            ...
            Row(
                ...
                Button(
                    onClick = {
                        ...
                        if(city != null && editCityName.isNotBlank() && editProvinceName.isNotBlank()){
                            onUpdateCity(
                                city, City(name = editCityName, province = editProvinceName)
                            )
                            selectedCity = null
                        }
                    }
...
fun CityRow(city: City, onClick: () -> Unit) {
    Row(
        modifier = Modifier
            .fillMaxWidth()
            .padding(horizontal = 20.dp, vertical = 16.dp).clickable{
                onClick()
            }
    ) {
        Text(
...
@Composable
fun CityListScreenPreview() { ListyCity3Theme {
    CityListScreen(
        cities = listOf(
            City("Edmonton", "AB"),
            City("Vancouver", "BC"),
